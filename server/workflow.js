   ...
   // return true;
    ...
    switch (game_state) {
        ...
        case GAME_STATE.READY_TO_START:
            if (event == EventNetworkLED.StartGame || event == EventNetworkPlayer.Sensor || event == EventNetworkPlayer.Login || event == EventNetworkPlayer.HeartBeat || event == EventNetworkPlayer.EndGame)
                return true;
            break;
